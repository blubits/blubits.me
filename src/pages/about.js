...
const AboutPage = () => {
  return (
    <Layout pageTitle={"About me"}>
      <p className="font-semibold mt-3 mb-2">What's going to be here?</p>
      ...
      <p className="font-semibold mt-3 mb-2">Where am I right now?</p>
      ...
      <p className="font-semibold mt-3 mb-2">Where can you follow me?</p>
      ...
      <p className="font-semibold mt-3 mb-2">How can you contact me?</p>
...
export const Head = () => {
  return (
    <>
      <html lang="en" />
      <body className="bg-gradient-to-r from-gray-700 via-gray-900 to-black text-white font-sans" />
